...
<div class="container mt-5">
    <h2>Création d'une page avec un Header complet</h2>
    <form action="generate_full_header.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <div class="form-group">
            <label for="jumbotronImage">Image pour le header :</label>
            <input type="file" class="form-control-file" id="jumbotronImage" name="jumbotronImage" required>
        </div>
